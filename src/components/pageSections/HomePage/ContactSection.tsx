      ...
      <ContainerInner className="bg-[#fff]">
        ...
        >
          ...
          <div className=" md:w-[65ch]">
            <div>
              <h1
                className={`${openSans.className} font-openSans text-[#09090A] text-[36px] md:text-[44px] font-[600] leading-[136%] capitalize`}
              >
                Reach Out—Let&lsquo;s Make It Happen
              </h1>
              <p
                className={` mt-[16px] md:mt-[24px] ${inter.className} font-inter text-[#40424D] text-[16px] font-[400] leading-[175%]`}
              >
            ...
            {/* contact info  */}
            <div className="flex flex-col gap-[16px] md:gap-[20px] mt-[24px] md:mt-[48px]">
              {/* first contact item  */}
              ...
              <div className="flex gap-[16px] items-center">
                ...
                <div>
                  ...
                  <span
                    className={`${openSans.className} underline mt-[2px] font-openSans text-[#000] text-[16px] font-[600] leading-[150%]`}
                  >
                    hello@johndoe.com
                  </span>
                </div>
              ...
              <div className="mt-[36px] lg:mt-[48px]">
                <h3
                  className={` ${outfit.className} font-outfit text-[#000] text-[26px] font-[500] leading-[133%] capitalize `}
                >
                  follow us
                </h3>
          ...
          <div className="bg-[#DCDEE580] w-full md:w-[580px] py-[48px] md:h-[615px] rounded-[28px] px-[20px] md:px-[58px] flex flex-col items-center justify-center">
            <form
            ...
            >
              ...
              <div>
                ...
                <input
                  className={`${inter.className} font-inter capitalize mt-[8px] w-[302px] md:w-[465px] px-[16px] md:px-[24px] py-[14px] md:py-[16px] rounded-[12px] text-[14px] md:text-[16px] text-[#A1A4B2] font-[400] leading-[150%]`}
